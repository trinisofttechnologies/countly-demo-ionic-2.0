...
export class HomePage {
  ...
  constructor(public navCtrl: NavController, public countly: Countly) {
  }
    ...
    testAndroidPush = function(){
        this.countly.onRegistrationId({
            "registrationId": "1234567890",
            "mode": this.countly.messagingMode.PRODUCTION,
    ...
    onRegistrationId() {
        ...
        push.on('registration', function(data) {
            this.countly.onRegistrationId({
                ...
                "mode": this.countly.messagingMode.TEST,
                "projectId": "881000050249" // only for google / android
            })
